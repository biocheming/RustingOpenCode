use rocode_provider::{ChatRequest, Message, ModelInfo, ProviderRegistry};

fn create_test_registry() -> ProviderRegistry {
    let mut registry = ProviderRegistry::new();

    registry.register(rocode_provider::anthropic::AnthropicProvider::new(
        "test-key",
    ));
    ...
    registry.register(rocode_provider::openrouter::OpenRouterProvider::new(
        "test-key",
    ));
